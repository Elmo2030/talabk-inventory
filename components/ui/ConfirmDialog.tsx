    ...
    <ConfirmDialogContext.Provider value={{ confirm }}>
      ...
      {state.isOpen && (
        <div className="fixed inset-0 z-[9998] flex items-center justify-center">
          ...
          {/* Dialog */}
          <div
            className="relative bg-white rounded-2xl shadow-2xl w-full max-w-sm mx-4 p-6 space-y-4"
            dir="rtl"
            role="alertdialog"
            aria-modal="true"
          >
            <div className="flex items-start gap-4">
              ...
              <div className="flex-1 min-w-0">
                ...
                <p className="text-sm text-slate-600 mt-1 leading-5">{options.description}</p>
              </div>
            </div>
