      ...
      <div className="bg-white border border-[#E5E5EA] rounded-xl overflow-hidden">
        {filtered.length === 0 ? (
          <div className="py-16 text-center">
            <ShoppingCart className="w-12 h-12 text-[#E5E5EA] mx-auto mb-3" />
            <p className="text-[#6C6C70] font-medium">لا توجد فواتير</p>
            <p className="text-xs text-[#AEAEB2] mt-1">أضف فاتورة شراء جديدة لتبدأ</p>
          </div>
        ) : (
