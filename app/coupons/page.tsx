    ...
    <form onSubmit={handleSubmit} className="space-y-4" dir="rtl">
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
        ...
        <div>
          ...
          />
          <p className="text-xs text-slate-400 mt-1">0 = بدون حد أدنى</p>
        </div>
        <div>
          ...
          />
          <p className="text-xs text-slate-400 mt-1">0 = غير محدود</p>
        </div>
        <div>
          ...
          />
          <p className="text-xs text-slate-400 mt-1">اتركه فارغاً للكوبون الدائم</p>
        </div>
      </div>
      ...
      <div className="flex items-center gap-3 p-3 bg-slate-50 rounded-xl">
        ...
        >
          {isActive ? <ToggleRight className="w-7 h-7" /> : <ToggleLeft className="w-7 h-7 text-slate-400" />}
        </button>
        <div>
          <p className="text-sm font-medium text-slate-900">{isActive ? 'الكوبون نشط' : 'الكوبون معطل'}</p>
          <p className="text-xs text-slate-500">يمكن تفعيل/تعطيل الكوبون في أي وقت</p>
        </div>
      </div>
    ...
    <div dir="rtl">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 mb-6">
        <div>
          ...
          <p className="text-xs sm:text-sm text-slate-500 mt-1">إدارة كوبونات الخصم للعملاء</p>
        </div>
        <Button
          ...
          <div className="overflow-x-auto">
            <table className="w-full text-sm">
              <thead className="bg-slate-50 border-b border-slate-200">
                <tr>
                  <th className="px-4 py-3 text-right text-xs font-semibold text-slate-600 uppercase">الكود</th>
                  <th className="px-4 py-3 text-right text-xs font-semibold text-slate-600 uppercase">الخصم</th>
                  <th className="px-4 py-3 text-right text-xs font-semibold text-slate-600 uppercase">الحد الأدنى</th>
                  <th className="px-4 py-3 text-right text-xs font-semibold text-slate-600 uppercase">الاستخدامات</th>
                  <th className="px-4 py-3 text-right text-xs font-semibold text-slate-600 uppercase">الانتهاء</th>
                    ...
                    <tr key={c.id} className="hover:bg-slate-50 transition-colors">
                      <td className="px-4 py-3">
                        <div className="flex items-center gap-2">
                          <span className="font-mono font-bold text-slate-900 bg-slate-100 px-2 py-0.5 rounded-lg text-xs tracking-wider">
                            {c.code}
                          </span>
                          <button
